...
import { Heart, Plus, Trash2, Check, Flame, Dumbbell, Activity, Scale, TrendingUp, Calendar, ChevronDown, Edit2, MoreVertical, X, Save } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fade-in flex flex-col h-full">
        ...
        {activeTab === 'habits' && (
            <div className="space-y-6">
                ...
                {/* Edit Habit Form */}
                {editingId && (
                  <div className="glass-card rounded-xl p-6 border border-accent/50 max-w-lg mx-auto">
                    ...
                    <div className="flex gap-4">
                      <input 
                        ...
                        className="w-16 text-center p-3 rounded-lg bg-bg-tertiary border border-border focus:border-accent outline-none text-xl" 
                      />
                      <input 
                        type="text" 
                        value={editForm.name} 
                    ...
                    <div className="flex justify-end gap-3 mt-4">
                      <button 
                        ...
                        className="px-4 py-2 rounded-lg hover:bg-bg-tertiary text-gray-400"
                      >
                        Cancel
                      </button>
                      <button 
                        onClick={() => {
                          ...
                          if (habit) {
                            ...
                            const updatedHabits = habits.map(h => 
                              h.id === editingId ? { ...h, name: editForm.name, icon: editForm.icon } : h
                            );
                            // You may need to update context here
                            setEditingId(null);
                          }
                        }} 
                        className="bg-accent px-6 py-2 rounded-lg font-medium"
                      >
                        Save
                      </button>
                    </div>
                                        ...
                                        <td className="p-4 text-center">
                                            <div className="relative">
                                              <button 
                                                ...
                                                className="text-gray-500 hover:text-gray-300 opacity-0 group-hover:opacity-100 transition-all p-2"
                                              >
                                              ...
                                              {menuOpen === h.id && (
                                                <div className="absolute right-0 mt-1 w-32 bg-gray-900 border border-gray-700 rounded-lg shadow-lg z-20">
                                                  <button
                                                    onClick={() => {
                                                      setEditingId(h.id);
                                                      setEditForm({ name: h.name, icon: h.icon });
                                                      setMenuOpen(null);
                                                    }}
