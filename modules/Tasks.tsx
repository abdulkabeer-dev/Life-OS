...
import { Check, Plus, Trash2, Calendar, AlertCircle, AlertTriangle, Info, Play, Pause, Square, X, Edit2, MoreVertical, Save } from 'lucide-react';

const Tasks: React.FC = () => {
  const { data, toggleTask, deleteTask, addTask, updateTask } = useLifeOS();
  ...
  const [editForm, setEditForm] = useState({ title: '', description: '', priority: 'medium' as Priority, dueDate: '' });
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 animate-fade-in relative">
        ...
        <div className="lg:col-span-3 space-y-6">
            ...
            {/* Edit Form */}
            {editingId && (
              <div className="glass-card rounded-xl p-5 space-y-4 mb-6">
                ...
                <input
                  ...
                  className="w-full p-3 rounded-lg bg-bg-tertiary border border-border text-white placeholder-gray-500"
                />
                ...
                <textarea
                  ...
                  className="w-full p-3 rounded-lg bg-bg-tertiary border border-border text-white placeholder-gray-500 h-16 resize-none"
                />
                ...
                <div className="grid grid-cols-2 gap-4">
                  <input
                    ...
                    className="p-3 rounded-lg bg-bg-tertiary border border-border text-white"
                  />
                  <select
